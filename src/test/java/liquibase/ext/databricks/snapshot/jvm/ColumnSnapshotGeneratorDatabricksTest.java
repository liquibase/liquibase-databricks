...
class ColumnSnapshotGeneratorDatabricksTest {
    ...
    private static final String EXPECTED_SHOW_CREATE_QUERY = "SHOW CREATE TABLE main.oleh.tablewithdefaultvalues;";
    private static final String SHOW_CREATE_TABLE_RESPONSE = "CREATE TABLE main.oleh.tablewithdefaultvalues(" +
