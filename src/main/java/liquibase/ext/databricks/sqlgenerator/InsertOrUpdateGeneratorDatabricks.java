...
public class InsertOrUpdateGeneratorDatabricks extends InsertOrUpdateGenerator {
    ...
    @Override
    protected String getUpdateStatement(InsertOrUpdateStatement insertOrUpdateStatement, Database database, String whereClause,
    ...
    protected String getRecordCheck(InsertOrUpdateStatement insertOrUpdateStatement, Database database, String whereClause) {
        return "MERGE INTO " + insertOrUpdateStatement.getTableName() + " AS target USING (SELECT 1) AS source ON target." + whereClause + " WHEN MATCHED " +
                "THEN ";
    }
